...
export class ProductCardComponent {
  ...
  constructor(http: HttpClient, private addProductsService: AddProductsService, private addCartService: AddCartService) {
  ...
  async reserve(producto?: Product) {
    ...
    if (producto) {
      ...
      if(producto.stock>0){
        ...
        await this.addCartService.addToCart(producto);
      }
